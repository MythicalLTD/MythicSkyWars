...
import systems.mythical.mythicskywars.events.MythicSkywarsGameEventAnnounceEvent;
import systems.mythical.mythicskywars.events.MythicSkywarsGameEventTriggerEvent;
...
public abstract class MatchEvent {
    ...
    public void doEvent() {
        ...
        MythicSkywarsGameEventTriggerEvent bukkitEvent = new MythicSkywarsGameEventTriggerEvent(this);
    ...
    public void announceTimer() {
        ...
        // Bukkit event
        MythicSkywars swr = MythicSkywars.get();
        MythicSkywarsGameEventAnnounceEvent bukkitEvent = new MythicSkywarsGameEventAnnounceEvent(this);
        swr.getServer().getPluginManager().callEvent(bukkitEvent);
        if (bukkitEvent.isCancelled()) {
            return;
        }
