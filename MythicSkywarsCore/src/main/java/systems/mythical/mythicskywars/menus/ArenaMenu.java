...
import systems.mythical.mythicskywars.game.cages.CageType;
import systems.mythical.mythicskywars.game.signs.SWRSign;
import systems.mythical.mythicskywars.listeners.ChatListener;
...
public class ArenaMenu {
    ...
    public ArenaMenu(String key, GameMap gMap) {
        ...
        Runnable update = () -> {
            if (MythicSkywars.getIC().hasViewers(key)) {
                ...
                ItemStack min = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.DIAMOND_HELMET, 1), lores, "Minimum Players");
                ...
                ItemStack status = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.MAP, 1), lores, "Arena Status");
                ...
                ItemStack display = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.NAME_TAG, 1), lores, "Display Name");
                ...
                ItemStack creator = MythicSkywars.getNMS().getItemStack(MythicSkywars.getNMS().getMaterial("SKULL_ITEM"), lores, "Map Creator");
                ...
                ItemStack signs = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.valueOf(signItem), 1), lores, "Join Signs");
                ...
                ItemStack spectate = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.COMPASS, 1), lores, "Spectate");

                lores.clear();
                lores.add(ChatColor.AQUA + "Shift Left Click to");
                lores.add(ChatColor.AQUA + "End Current Match!");
                ItemStack end = MythicSkywars.getNMS().getItemStack(new ItemStack(MythicSkywars.getNMS().getMaterial("ENDER_PORTAL_FRAME")), lores, "End Match");
                ...
                ItemStack edit = MythicSkywars.getNMS().getItemStack(new ItemStack(MythicSkywars.getNMS().getMaterial("WORKBENCH")), lores, "Edit Map");
                ...
                ItemStack save = MythicSkywars.getNMS().getItemStack(new ItemStack(Material.BOOK, 1), lores, "Save Map");
                ...
                ItemStack cage = MythicSkywars.getNMS().getItemStack(new ItemStack(MythicSkywars.getNMS().getMaterial("IRON_FENCE")), lores, "Cage Type");
                ...
                ItemStack teams = MythicSkywars.getNMS().getItemStack(new ItemStack(MythicSkywars.getNMS().getMaterial("REDSTONE_COMPARATOR")), lores, "Teams");
        ...
        MythicSkywars.getIC().getMenu(key).setUpdate(update);
    }
