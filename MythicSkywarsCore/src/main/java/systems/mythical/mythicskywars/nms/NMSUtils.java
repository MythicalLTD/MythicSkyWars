package systems.mythical.mythicskywars.nms;
...
public class NMSUtils {
    ...
    public static NMS loadNMS(MythicSkywars plugin) {
        ...
        try {
            ...
            final Class<?> clazz = Class.forName("systems.mythical.mythicskywars.nms." + nmsImplVersionStr + ".NMSHandler");
        ...
        plugin.getLogger().severe(
                "===================\n" +
                        ...
                        "If you are on a supported version but see ClassNotFoundException for NMSHandler, deploy the shaded jar built from module skywars-assembly (MythicSkywars-*.jar under the repo target folder), not the MythicSkywarsCore jar alone.\n" +
