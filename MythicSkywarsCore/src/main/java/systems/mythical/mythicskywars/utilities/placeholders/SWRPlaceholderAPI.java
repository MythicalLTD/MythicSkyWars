...
public class SWRPlaceholderAPI extends PlaceholderExpansion {
    ...
    public String getVersion() {
        return MythicSkywars.get().getDescription().getVersion();
    }
    ...
    public String onPlaceholderRequest(Player p, String identifier) {
        ...
        if ("time".equals(id)) {
            GameMap gameMap = MythicSkywars.get().getMatchManager().getPlayerMap(p);
        ...
        PlayerStat stat = MythicSkywars.get().getPlayerStat(p);
        if (stat == null) {
    ...
    public static String getLeaderBoardVariable(String var, @Nullable LeaderType type) {
        ...
        if (MythicSkywars.getLB() != null) {
            List<Leaderboard.LeaderData> topList = MythicSkywars.getLB().getTopList(type);
