...
public class Config {
    ...
    public void load() {
        if (!loading) {
            ...
            joinCompassRandomJoin =     SkyWarsReloaded.get().getConfig().getBoolean("items.joinCompassRandomJoin", false);
            ...
            optionsSlot =           SkyWarsReloaded.get().getConfig().getInt("enabledMenus.optionsSlot", 7);
            ...
            soulWellEnabled = SkyWarsReloaded.get().getConfig().getBoolean("soulwell.enabled", true);
            soulWellSoulsPerKill = SkyWarsReloaded.get().getConfig().getInt("soulwell.souls-per-kill", 1);
            soulWellSoulsPerSpin = SkyWarsReloaded.get().getConfig().getInt("soulwell.souls-per-spin", 10);
            soulWellMaxSpinsAtOnce = SkyWarsReloaded.get().getConfig().getInt("soulwell.max-spins-at-once", 4);
            soulWellXezbethPermission = SkyWarsReloaded.get().getConfig().getString("soulwell.xezbeth-permission", "sw.soulwell.xezbethluck");
            soulWellAnimTicksPerFrame = SkyWarsReloaded.get().getConfig().getInt("soulwell.animation-ticks-per-frame", 2);
            soulWellAnimFrames = SkyWarsReloaded.get().getConfig().getInt("soulwell.animation-frames", 24);
            soulWellOptionsMenuSlot = SkyWarsReloaded.get().getConfig().getInt("soulwell.options-menu-slot", 22);
            soulWellWeightCoins = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.coins.weight", 40);
            soulWellWeightXp = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.xp.weight", 30);
            soulWellWeightCage = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.cage.weight", 15);
            soulWellWeightKit = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.kit.weight", 10);
            soulWellWeightPerk = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.perk.weight", 5);
            soulWellWeightCommand = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.command.weight", 0);
            soulWellCoinsMin = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.coins.min", 5);
            soulWellCoinsMax = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.coins.max", 30);
            soulWellXpMin = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.xp.min", 5);
            soulWellXpMax = SkyWarsReloaded.get().getConfig().getInt("soulwell.rewards.xp.max", 20);
            soulWellKitAllowList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.kit.allow-list");
            soulWellKitDenyList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.kit.deny-list");
            soulWellPerkAllowList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.perk.allow-list");
            soulWellPerkDenyList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.perk.deny-list");
            soulWellCageAllowList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.cage.allow-list");
            soulWellCageDenyList = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.cage.deny-list");
            soulWellCommandRewards = SkyWarsReloaded.get().getConfig().getStringList("soulwell.rewards.command.commands");
    ...
    public void save() {
        ...
        SkyWarsReloaded.get().getConfig().set("items.joinCompassRandomJoin", joinCompassRandomJoin);
