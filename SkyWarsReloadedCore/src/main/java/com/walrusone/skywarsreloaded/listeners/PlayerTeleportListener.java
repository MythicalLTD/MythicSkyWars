        ...
        if (gameMap == null) {
            ...
            if (SkyWarsReloaded.getCfg().getSpawn() != null) {
                ...
                if (wasInSpawnWorld && !isGoingToSpawnWorld) {
                    ...
                    if (SkyWarsReloaded.getCfg().isStatsItemEnabled() &&
                            player.getInventory().getItem(SkyWarsReloaded.getCfg().getStatsItemPos()) != null &&
                            player.getInventory().getItem(SkyWarsReloaded.getCfg().getStatsItemPos()).equals(SkyWarsReloaded.getIM().getItem("statsitem"))) {
                        player.getInventory().setItem(SkyWarsReloaded.getCfg().getStatsItemPos(), new ItemStack(Material.AIR, 1));
                    }
                    if (SkyWarsReloaded.getCfg().isBackToLobbyItemEnabled() &&
                            player.getInventory().getItem(SkyWarsReloaded.getCfg().getBackToLobbyPos()) != null &&
                            player.getInventory().getItem(SkyWarsReloaded.getCfg().getBackToLobbyPos()).equals(SkyWarsReloaded.getIM().getItem("backlobbyitem"))) {
                        player.getInventory().setItem(SkyWarsReloaded.getCfg().getBackToLobbyPos(), new ItemStack(Material.AIR, 1));
                    }
