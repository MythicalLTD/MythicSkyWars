...
public class PlayerManager {
    ...
    public void removePlayer(final Player playerRemoved, PlayerRemoveReason removeReason, @Nullable EntityDamageEvent.DamageCause deathCause, boolean shouldSendToLobbyIn, boolean announceToOthers) {
        ...
        if (playerData == null) {
            ...
            } else if (SkyWarsReloaded.getCfg().debugEnabled()) {
        ...
        if (gameMap != null) {
            ...
            SkyWarsReloaded.get().getLogger().info("PlayerManager::removePlayer: " + playerRemoved.getName()
    ...
    public void updateStatsForKiller(Player killer) {
        ...
        if (killerData != null) {
            ...
            if (SkyWarsReloaded.getCfg().isSoulWellEnabled()) {
                int per = Math.max(0, SkyWarsReloaded.getCfg().getSoulWellSoulsPerKill());
                if (per > 0) {
