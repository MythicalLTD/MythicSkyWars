...
public class UpdateChecker {
    ...
    public UpdateChecker(SkyWarsReloaded plugin, String repoOwner, String repoName, boolean checkBeta, boolean autoUpdate) {
        this.plugin = plugin;
    ...
    private File getPluginFile() {
        try {
            ...
            File[] files = pluginsFolder.listFiles((dir, name) ->
                    name.toLowerCase().startsWith("swr-") && name.toLowerCase().endsWith(".jar"));
