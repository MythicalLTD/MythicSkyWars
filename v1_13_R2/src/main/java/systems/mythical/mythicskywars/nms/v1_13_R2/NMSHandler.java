package systems.mythical.mythicskywars.nms.v1_13_R2;
...
public class NMSHandler extends systems.mythical.mythicskywars.nms.v1_12_R1.NMSHandler {
    ...
    public void applyTotemEffect(Player player) {
        ...
        }.runTaskTimer(MythicSkywars.get(), 0, 1);
    }
}
