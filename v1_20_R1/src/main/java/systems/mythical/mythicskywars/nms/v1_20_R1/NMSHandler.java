package systems.mythical.mythicskywars.nms.v1_20_R1;
...
public class NMSHandler extends systems.mythical.mythicskywars.nms.v1_19_R1.NMSHandler {
    ...
    private final NamespacedKey itemIdKey = new NamespacedKey("skywars", "item_id");
